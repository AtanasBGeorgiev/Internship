...
import { FaMoneyBillAlt, FaUniversity, FaChartLine, FaRegNewspaper, FaTag, FaApple, FaArchive, FaPenNib } from "react-icons/fa";
...
import { FaArrowUpLong, FaPlus, FaPencil } from "react-icons/fa6";
import { RxCross2 } from "react-icons/rx";
import { SiJsonwebtokens } from "react-icons/si";

import Decimal from "decimal.js";
import { DashboardNavbarLink, DashboardMoreInfo, SectionToolTip } from "./Components/Dashboards";
...
import { Arrow, LangSwitcher, ShowMessage } from "./Components/Common";
            ...
            <div id="wrapper" className="grid grid-cols-12 bg-gray-100 p-5">
                <div id="sitdeNavbar" className="col-span-2 border-x-2 border-gray-300 bg-white">
                    <div id="userActions" className="py-2 flex flex-col items-start justify-center">
                        <div id="redButton" className="flex items-center flex-row gap-3 justify-center w-4/5
                            mx-auto my-3 font-bold text-center p-2 bg-red-600 text-white rounded-s">
                            <div>
                                <FaArrowUpLong />
                                <PiCoinsFill />
                            </div>
